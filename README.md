...
- **Comfortable editing:** undo/redo, line numbers, current-line highlight, go to line, word wrap, touch-interactive scrollbars, adjustable font size (12 by default), light/dark themes, and document statistics. Drag a scrollbar thumb or tap its track to move through the document. Turn word wrap off to use the horizontal scrollbar for long lines.
